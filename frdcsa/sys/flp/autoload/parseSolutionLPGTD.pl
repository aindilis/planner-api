...
parseSolution(F, O):-
	...
	(   (	Planner = 'LPG') ->
	    (	atomic_list_concat(['/var/lib/myfrdcsa/codebases/minor/planner-api/scripts/trim.pl',F,'>',F2],' ',Command) ) ;
	    (	(   Planner = 'OPTIC_CLP') -> atomic_list_concat(['/var/lib/myfrdcsa/codebases/minor/planner-api/scripts/trim_optic_clp.pl',F,'>',F2],' ',Command) ; true)),
